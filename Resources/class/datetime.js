(function() {	
	 ...
	 */
	BizDir.datetime.strtotime = function (str, now) {
	...
	BizDir.datetime.prettyDate = function (time) {
	...
	BizDir.datetime.getTwitterInterval = function (strDateTime) {
	    return BizDir.datetime.prettyDate(BizDir.datetime.strtotime(strDateTime));
	};
	
	BizDir.datetime.dayToName = function (day) {
	    switch (day) {
	    case 0:
	        return 'Sunday';
	    case 1:
	...
	BizDir.datetime.monthToName = function (month) {
	    switch (month) {
	    case 1:
	        return 'January';
	    case 2:
	...
	BizDir.datetime.monthToNameShort = function (month) {
	    switch (month) {
	    case 1:
	        return 'Jan';
	    case 2:
	...
	BizDir.datetime.cleanDate = function (date) {
	    var label;
	    switch (date.getDate()) {
	    case 1:
	        label = 'st';
	    ...
	    return BizDir.datetime.dayToName(date.getDay()) + ', ' + BizDir.datetime.monthToName(date.getMonth() + 1) + ' ' + date.getDate() + label;
	};
	
	BizDir.datetime.cleanTime = function (time) {
