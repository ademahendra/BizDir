BizDir.ui.createCalendarTab1Window = function () {
	...
	tabBarNews.addEventListener('click', function(e){
		switch(e.index){
	        case 0: {	        	
	        	var data1 = BizDir.selectEvent(1);
				displayEvent(data1);
	            break;
	        }
	        case 1: {	        	
	        	var data1 = BizDir.selectEvent(2);
				displayEvent(data1);
	            break;
	        }
       	}
	...
	function displayEvent(data){
		...
		for(var i = 0; i < data.length; i++){
			...
			row.addEventListener('click', function(e){
				Ti.API.info('::> '+e.source.data.startDate);
				BizDir.calendarTab1.open(BizDir.ui.createCalendarEventWindow(e.source.data));
				// BizDir.ui.createCalendarEventWindow(e.source.data).open();
			});
