BizDir.ui.createCalendarTab2Window = function () {
	...
	tabBarNews.addEventListener('click', function(e){
		switch(e.index){
	        case 0: {
	        	var data1 = BizDir.selectEvent(3);
				displayEvent(data1);
	            break;
	        }
	        case 1: {
	        	var data1 = BizDir.selectEvent(4);
				displayEvent(data1);
	            break;
	        }
       	}
	...
	function displayEvent(data){
		...
		for(var i = 0; i < data.length; i++){
			...
			row.addEventListener('click', function(e){
				BizDir.calendarTab2.open(BizDir.ui.createCalendarEventWindow(e.source.data));
			});
